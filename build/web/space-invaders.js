...
function findWasmBinary() {
  return locateFile('space-invaders.wasm');
}
...
var ASM_CONSTS = {
  92488: () => { if (document.fullscreenElement) return 1; },  
 92534: () => { return Module.canvas.width; },  
 92566: () => { return parseInt(Module.canvas.style.width); },  
 92614: () => { document.exitFullscreen(); },  
 92641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92714: () => { if (document.fullscreenElement) return 1; },  
 92760: () => { return Module.canvas.width; },  
 92792: () => { return screen.width; },  
 92817: () => { document.exitFullscreen(); },  
 92844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 92977: () => { return window.innerWidth; },  
 93003: () => { return window.innerHeight; },  
 93030: () => { if (document.fullscreenElement) return 1; },  
 93076: () => { return Module.canvas.width; },  
 93108: () => { return parseInt(Module.canvas.style.width); },  
 93156: () => { if (document.fullscreenElement) return 1; },  
 93202: () => { return Module.canvas.width; },  
 93234: () => { return screen.width; },  
 93259: () => { return window.innerWidth; },  
 93285: () => { return window.innerHeight; },  
 93312: () => { if (document.fullscreenElement) return 1; },  
 93358: () => { return Module.canvas.width; },  
 93390: () => { return screen.width; },  
 93415: () => { document.exitFullscreen(); },  
 93442: () => { if (document.fullscreenElement) return 1; },  
 93488: () => { return Module.canvas.width; },  
 93520: () => { return parseInt(Module.canvas.style.width); },  
 93568: () => { document.exitFullscreen(); },  
 93595: ($0) => { Module.canvas.style.opacity = $0; },  
 93633: () => { return screen.width; },  
 93658: () => { return screen.height; },  
 93684: () => { return window.screenX; },  
 93711: () => { return window.screenY; },  
 93738: () => { return window.devicePixelRatio; },  
 93774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93827: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93878: () => { Module.canvas.style.cursor = 'none'; },  
 93915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94222: () => { if (document.pointerLockElement) return 1; },  
 94269: () => { if (document.fullscreenElement) return 1; },  
 94315: () => { return window.innerWidth; },  
 94341: () => { return window.innerHeight; }
};
